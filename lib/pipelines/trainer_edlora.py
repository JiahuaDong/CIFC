...
from lib.models.edlora import (LoRALinearLayer, LagrangeTerm, revise_edlora_unet_attention_controller_forward,
                                     revise_edlora_unet_attention_forward)
from lib.pipelines.pipeline_edlora import bind_concept_prompt
from lib.utils.ptp_util import AttentionStore
...
class EDLoRATrainer(nn.Module):
    ...
    def set_finetune_cfg(self, finetune_cfg):
        ...
        if finetune_cfg['unet']['enable_tuning'] and finetune_cfg['unet'].get('lora_cfg'):
            ...
            num = sum(p.numel() for p in params_list)
        # 4. optimize params
    ...
    def delta_state_dict(self):
        delta_dict = {'new_concept_embedding': {}, 'unet': {}, 'lag': {}}
