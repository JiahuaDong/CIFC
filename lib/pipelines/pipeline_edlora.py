...
from lib.models.edlora import (revise_edlora_unet_attention_controller_forward,
...
class EDLoRAPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        lora_num: int =1,
        no_cross_attention_kwargs: bool = False,
    ):
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_preds=[]
                for id in range(lora_num):
                    # cross_attention_kwargs['lora_id']=id
                    if no_cross_attention_kwargs:
