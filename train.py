...
from lib.data.lora_dataset import LoraDataset
...
from lib.pipelines.trainer_edlora import EDLoRATrainer
from lib.utils.convert_edlora_to_diffusers import convert_edlora
from lib.utils.util import MessageLogger, dict2str, reduce_loss_dict, set_path_logger
...
def train(args):
    ...
    # set experiment dir
    opt['name'] = f'task_{args.task_id}'
    with accelerator.main_process_first():
        set_path_logger(accelerator, args.output_dir, args.opt, opt, is_train=True)
    ...
    # Load model
    opt['models']['orthogonal'] = args.orthogonal
    opt['models']['pretrained_path'] = args.pretrained_path
    opt['models']['task_id'] =args.task_id
    opt['models']['output_dir'] =args.output_dir
    opt['models']['finetune_cfg']['unet']['lora_cfg']['rank'] =args.rank
...
if __name__ == '__main__':
    ...
    parser.add_argument('--opt', type=str, default='./options/cidm/task_1.yml')
    parser.add_argument('--pretrained_path', type=str, default='your_model_path_of_SD1.5')
    parser.add_argument('--output_dir', type=str, default='./output')
    parser.add_argument('--orthogonal', type=float, default=0.1)
